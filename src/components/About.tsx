...
const About = () => {
    return (
        <section id="about" className="py-20 bg-white relative overflow-hidden">
            ...
            <div className="absolute top-20 left-10 w-64 h-64 bg-red-100 rounded-full blur-3xl opacity-40 animate-float-slow"></div>
            <div className="absolute bottom-20 right-10 w-80 h-80 bg-lime-100 rounded-full blur-3xl opacity-30 animate-float-slow" style={{ animationDelay: '2s' }}></div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                                    ...
                                    <div className="mt-8 pt-8 border-t border-slate-100 flex items-center gap-6">
                                        ...
                                        <div>
                                            <AnimatedCounter
                                                target={98}
                                                suffix="%"
                                                className="block text-3xl font-bold text-secondary"
                                            />
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        <FadeIn delay={0.2} direction="left">
                            <div className="glass-card p-6 rounded-2xl border border-slate-100 hover:shadow-md transition-all duration-300 hover-lift group">
                                <div className="flex items-center mb-3">
                                    <div className="p-3 bg-red-50 rounded-lg text-primary group-hover:animate-pulse-glow transition-all">
                                        <Users className="h-6 w-6 icon-hover-spin" />
                                    </div>
                        ...
                        <FadeIn delay={0.3} direction="left">
                            <div className="glass-card p-6 rounded-2xl border border-slate-100 hover:shadow-md transition-all duration-300 hover-lift group">
                                <div className="flex items-center mb-3">
                                    <div className="p-3 bg-yellow-50 rounded-lg text-secondary group-hover:animate-pulse-glow-lime transition-all">
                                        <Award className="h-6 w-6 icon-hover-spin" />
                                    </div>
                        ...
                        <FadeIn delay={0.4} direction="left">
                            <div className="glass-card p-6 rounded-2xl border border-slate-100 hover:shadow-md transition-all duration-300 hover-lift group">
                                <div className="flex items-center mb-3">
                                    <div className="p-3 bg-red-50 rounded-lg text-primary group-hover:animate-pulse-glow transition-all">
                                        <Globe className="h-6 w-6 icon-hover-spin" />
                                    </div>
